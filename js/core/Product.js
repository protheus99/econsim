...
export class ProductRegistry {
    ...
    registerRawMaterials() {
        const rawMaterials = [
            ...
            { id: 12, name: 'Hardwood Logs', category: 'TIMBER', icon: '🌳', basePrice: 60, weight: 1.8, unit: 'cord', necessityIndex: 0.3, minB2BQuantity: 25, minRetailQuantity: 0 },

            // Farming - Crops (B2B: bulk bushels/bales/tons, no retail)
            { id: 13, name: 'Wheat', category: 'GRAINS', icon: '🌾', basePrice: 10, weight: 0.8, unit: 'bushel', necessityIndex: 0.9, minB2BQuantity: 1000, minRetailQuantity: 0 },
            { id: 14, name: 'Rice', category: 'GRAINS', icon: '🍚', basePrice: 12, weight: 0.8, unit: 'bushel', necessityIndex: 0.9, minB2BQuantity: 1000, minRetailQuantity: 0 },
            { id: 15, name: 'Corn', category: 'GRAINS', icon: '🌽', basePrice: 8, weight: 0.7, unit: 'bushel', necessityIndex: 0.8, minB2BQuantity: 1000, minRetailQuantity: 0 },
            { id: 16, name: 'Cotton', category: 'INDUSTRIAL_CROPS', icon: '🧵', basePrice: 25, weight: 0.5, unit: 'bale', necessityIndex: 0.4, minB2BQuantity: 100, minRetailQuantity: 0 },
            { id: 17, name: 'Sugarcane', category: 'INDUSTRIAL_CROPS', icon: '🎋', basePrice: 15, weight: 1.0, unit: 'ton', necessityIndex: 0.5, minB2BQuantity: 100, minRetailQuantity: 0 },
            { id: 18, name: 'Coffee Beans', category: 'INDUSTRIAL_CROPS', icon: '☕', basePrice: 40, weight: 0.6, unit: 'bag', necessityIndex: 0.6, minB2BQuantity: 50, minRetailQuantity: 0 },

            // Farming - Livestock (B2B: bulk head/dozen, no retail)
            { id: 19, name: 'Cattle', category: 'LIVESTOCK', icon: '🐄', basePrice: 1200, weight: 500, unit: 'head', necessityIndex: 0.7, minB2BQuantity: 20, minRetailQuantity: 0 },
            { id: 20, name: 'Pigs', category: 'LIVESTOCK', icon: '🐷', basePrice: 400, weight: 100, unit: 'head', necessityIndex: 0.6, minB2BQuantity: 50, minRetailQuantity: 0 },
            { id: 21, name: 'Chickens', category: 'LIVESTOCK', icon: '🐔', basePrice: 15, weight: 2, unit: 'dozen', necessityIndex: 0.7, minB2BQuantity: 100, minRetailQuantity: 0 },
            { id: 22, name: 'Raw Milk', category: 'ANIMAL_PRODUCTS', icon: '🥛', basePrice: 5, weight: 1.0, unit: 'gallon', necessityIndex: 0.8, minB2BQuantity: 500, minRetailQuantity: 0 },
            { id: 23, name: 'Eggs', category: 'ANIMAL_PRODUCTS', icon: '🥚', basePrice: 3, weight: 0.5, unit: 'dozen', necessityIndex: 0.8, minB2BQuantity: 100, minRetailQuantity: 0 }
        ];
    ...
    registerSemiRawMaterials() {
        ...
        const semiRaw = [
            // Refined Metals (B2B: medium bulk, retail: hardware stores only)
            {
                ...
                minB2BQuantity: 25, minRetailQuantity: 1,
                inputs: [
            ...
            },
            {
                ...
                minB2BQuantity: 50, minRetailQuantity: 1,
            ...
            },
            {
                ...
                minB2BQuantity: 100, minRetailQuantity: 1,
            ...
            },
            {
                ...
                minB2BQuantity: 25, minRetailQuantity: 0,
            ...
            },
            {
                ...
                minB2BQuantity: 10, minRetailQuantity: 1,
            ...
            },
            {
                ...
                minB2BQuantity: 20, minRetailQuantity: 1,
    ...
    registerManufacturedGoods() {
        ...
        const manufactured = [
            ...
            // Vehicles (B2B: small lots for dealerships, retail: individual)
            {
                ...
                minB2BQuantity: 5, minRetailQuantity: 1,
                inputs: [
            ...
            },
            {
                ...
                minB2BQuantity: 24, minRetailQuantity: 1,
                inputs: [
